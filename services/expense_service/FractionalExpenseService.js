...
class FractionalExpenseService {
    ...
    async validateBreakup() {
        ...
        for (let participant of this.participants) {
            ...
            this.totalParts += participant.contribution;
    ...
    getContributionValue(contribution) {
        return (this.amount / this.totalParts) * Number(contribution);
    }

    getUsersContribution() {
        this.usersContributions = {};
        for (let participant of this.participants) {
            let currentContribution = this.getContributionValue(participant.contribution);
...
module.exports = FractionalExpenseService;