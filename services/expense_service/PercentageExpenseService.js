...
class PercenatgeExpenseService {
    ...
    async validateBreakup() {
        ...
        for (let participant of this.participants) {
            ...
            this.totalPercentage += participant.contribution;
    ...
    getContributionValue(contribution) {
        return (this.amount / 100) * Number(contribution);
    }
...
module.exports = PercenatgeExpenseService;